...
namespace DapperAndEntityFrameWorkCourse.Controllers
{
    public class CompaniesController : Controller
    {
        ICompanyRepository _compRepo;
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Name,Address,City,PostalCode,State")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Address,City,PostalCode,State")] Company company)
        {
